...
df_col_list = ['Ticker', 'Company Name', 'Sector', 'Industry','City', 'State', 'Close'] #, 'DividendDate']
#List of JSON keys from Yahoo Finance API
api_col_list = ['symbol', 'longName', 'sector', 'industry','city', 'state', 'regularMarketPreviousClose']#, 'dividendDate']
...
def getCompanyInfo(tickers, df_cols, api_cols):
    ...
    print(company_df)
    company_df.to_csv('yfinanceoutput.csv')
